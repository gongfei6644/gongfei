...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default=u'培训机构', max_length=20, choices=(
                                   ('pxjg', '培训机构'),
                                   ('gx', '高校'),
                                   ('gr', '个人')), verbose_name='机构类别')
...
class Teacher(models.Model):
    ...
    desc = models.CharField(max_length=200, verbose_name=u'描述', default=u"一个老师")
